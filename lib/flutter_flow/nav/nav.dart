...
class AppStateNotifier extends ChangeNotifier {
  McxtSocialFirebaseUser? initialUser;
  McxtSocialFirebaseUser? user;
  ...
  void update(McxtSocialFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/6c03742c6ae55503046919934771fbe3.jpg',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
